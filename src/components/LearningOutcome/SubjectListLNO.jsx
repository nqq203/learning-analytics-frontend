...
export default function SubjectListLNO({TableHeader,TableContent,setSubjectID}){
                        ...
                        <tbody>
                            ...
                            TableContent.map((item, index) => (
                                <tr key={index} style={{ borderBottom: "1px solid #eee" }}>
                                    ...
                                    <td style={{ textAlign: "center",padding: "1rem" }}>{item.SubjectName}</td>
                                    ...
                                    <td style={{ textAlign: "center",padding: "1rem" }}>
                                        <IconButton onClick={()=>setSubjectID(item.ID) }
                                        style={{zIndex: 10 }}>
