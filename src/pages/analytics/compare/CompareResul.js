...
const CompareResult = ({ students, onBack }) => {
    return (
        <Card>
            <h3 style={{ margin: "20px" }}>Kết quả so sánh</h3>
            <CardContent>
                ...
                <Button variant="contained" color="secondary" onClick={onBack} style={{ marginTop: "16px" }}>
                    Quay lại
                </Button>
            </CardContent>
        </Card>
